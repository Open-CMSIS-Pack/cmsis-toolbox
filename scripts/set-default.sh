...
case $1 in
  'Windows')
    ...
    gcc_default_path="C:/Program Files (x86)/GNU Arm Embedded Toolchain/10 2021.10/bin"
    iar_default_path="C:/Program Files/IAR Systems/Embedded Workbench 9.0/arm/bin"
    extension=".exe"
    ;;
  'Linux' | 'Darwin')
    # linux/macos
    ...
    gcc_default_path=~/gcc-arm-none-eabi-10.3-2021.10/bin
