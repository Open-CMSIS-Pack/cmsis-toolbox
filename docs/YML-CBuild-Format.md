...
&nbsp;&nbsp;&nbsp; `load:`                                |  Optional   | When applied the image is loaded to the target.
&nbsp;&nbsp;&nbsp; `debug:`                               |  Optional   | When applied the debug symbols of the image is used.
...
Load allows to specify additional attributes for the image.

`load:`                                                   |             | Content
:---------------------------------------------------------|-------------|:------------------------------------
&nbsp;&nbsp;&nbsp; `offset:`                              |  Optional   | Offset when downloading the image.
