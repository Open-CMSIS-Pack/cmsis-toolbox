...
- `csolution convert` - Uses **and updates** `cbuild-pack.yml`
- `csolution list ...` - Uses `cbuild-pack.yml`
- `csolution run` - Uses `cbuild-pack.yml`
- `csolution update-rte` - Uses **and updates** `cbuild-pack.yml`
