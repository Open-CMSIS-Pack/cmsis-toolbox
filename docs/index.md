...
Version            | Description
:-----------------:|:-------------------------
2.15.0             | CMSIS-Toolbox [2.15.0](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/releases) fixes [several issues](https://github.com/orgs/Open-CMSIS-Pack/projects/22/views/14). It documents a [workaround for stack unwinding issues with GDB debugger](Troubleshooting.md#stack-unwinding-fails-or-hangs), and adds [native CMake project integration](build-overview.md#native-cmake-build-integration), solution-level [`compiler-alias:`](YML-Input-Format.md#compiler-alias), support for per-library [`whole-archive`](YML-Input-Format.md#link), and enhanced pack and configuration [lifecycle management](build-overview.md#plm-of-software-packs).
2.14.0             | CMSIS-Toolbox [2.14.0](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/releases/tag/2.14.0) fixes [several issues](https://github.com/orgs/Open-CMSIS-Pack/projects/22/views/13). It adds [MLOps Integration](build-overview.md#mlops-integration), target-set-specific [temporary directories](YML-Input-Format.md#output-dirs), automatic rebase of [configuration files](build-overview.md#plm-of-configuration-files), enhanced [library generation](build-overview.md#generate-library) with [component](YML-Input-Format.md#components) `build-scope:`, and a command to [check for pack updates](build-overview.md#plm-of-software-packs).
2.13.0             | CMSIS-Toolbox [2.13.0](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/releases/tag/2.13.0) fixes [several issues](https://github.com/orgs/Open-CMSIS-Pack/projects/12/views/12) and adds [compiler support](installation.md#compiler-toolchains) for Microchip XC and CLANG_TI. The pyOCD command `run` supports [SEGGER RTT](pyOCD-Debugger.md#rtt). A [minimal setup](pyOCD-Debugger.md#minimal-setup) for pyOCD is documented.
...
2.2.0              | CMSIS-Toolbox [2.2.0](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/releases/tag/2.2.0) adds [generator integration](build-operation.md#generator-integration), extends [translation controls](YML-Input-Format.md#translation-control), adds the legacy [context set](build-tools.md#legacy-context-set), adds [pack locking](YML-CBuild-Format.md#lock-pack-versions), and improves [linker script management](build-overview.md#linker-script-management). Refer to [release information](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/releases/tag/2.2.0) for more details.
