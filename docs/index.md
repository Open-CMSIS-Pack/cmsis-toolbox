...
Version            | Description
:-----------------:|:-------------------------
2.14.0             | CMSIS-Toolbox [2.14.0](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/releases/tag/2.14.0) fixes [several issues](https://github.com/orgs/Open-CMSIS-Pack/projects/22). It adds [MLOps Information](build-overview.md#mlops-information), automatic rebase of [configuration files](build-overview.md#plm-of-configuration-files), enhanced [library generation](build-overview.md#generate-library) with [component](YML-Input-Format.md#components) `build-scope:`, and a command to [check for pack updates](build-overview.md#plm-of-software-packs).
2.13.0             | CMSIS-Toolbox [2.13.0](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/releases/tag/2.13.0) fixes [several issues](https://github.com/orgs/Open-CMSIS-Pack/projects/12) and adds [compiler support](installation.md#compiler-toolchains) for Microchip XC and CLANG_TI. The pyOCD command `run` supports [SEGGER RTT](pyOCD-Debugger.md#rtt). A [minimal setup](pyOCD-Debugger.md#minimal-setup) for pyOCD is documented.
