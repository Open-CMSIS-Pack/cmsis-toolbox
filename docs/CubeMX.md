...
`STM32CubeMX/MDK-ARM`               | Project files for MDK version 5; not used for *csolution projects*.

**Content of: `CubeMX.cgen.yml`**
...
1. **In CubeMX configure interrupt handlers** as shown below:
   ...
   Open the dialog *Pinout & Configuration - System Core NVIC - Code generation* and disable *Generate IRQ handler* and *Call HAL handler* for:
