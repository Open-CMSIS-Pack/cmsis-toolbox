...
The board specific software layer is used by many different projects. When a board configuration is generated by tools, for example MCUXpresso or STM32CubeMX, the [configure the generator](build-overview.md#configure-generator-output) output directory and import file usingthe [`generators:`](YML-Input-Format.md#generators) node in the `*.clayer.yml` file as shown below: 
