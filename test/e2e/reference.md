...
|linux-arm64-cmake3.31.12|Validate build-asm Example|8.88 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate build-c Example|3.60 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate build-cpp Example|5.47 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate build-set Example|1.96 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate executes Example|1.46 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate include-define Example|4.70 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate language-scope Example|4.69 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate linker-pre-processing Example|3.59 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate pre-include Example|3.79 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate whitespace Example|3.57 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Validate trustzone Example|10.58 s|Local Example Tests|
|linux-arm64-cmake3.31.12|Hello_FRDM-K32L3A6|15.06 s|Remote Example Tests|
|linux-arm64-cmake3.31.12|Hello_LPCXpresso55S69|12.66 s|Remote Example Tests|
|linux-arm64-cmake3.31.12|Csolution-examples|65.13 s|Remote Example Tests|
|linux-arm64-cmake3.31.12|keil-studio-get-started|4.85 s|Remote Example Tests|
|linux-arm64-cmake3.31.12|AVH-VSI|33.10 s|Remote Example Tests|
|linux-arm64-cmake4.3.3|Validate build-asm Example|8.97 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate build-c Example|4.31 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate build-cpp Example|5.21 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate build-set Example|2.15 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate executes Example|1.52 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate include-define Example|4.32 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate language-scope Example|4.89 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate linker-pre-processing Example|3.83 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate pre-include Example|4.01 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate whitespace Example|3.71 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Validate trustzone Example|12.16 s|Local Example Tests|
|linux-arm64-cmake4.3.3|Hello_FRDM-K32L3A6|18.19 s|Remote Example Tests|
|linux-arm64-cmake4.3.3|Hello_LPCXpresso55S69|13.01 s|Remote Example Tests|
|linux-arm64-cmake4.3.3|Csolution-examples|69.72 s|Remote Example Tests|
|linux-arm64-cmake4.3.3|keil-studio-get-started|4.74 s|Remote Example Tests|
|linux-arm64-cmake4.3.3|AVH-VSI|33.58 s|Remote Example Tests|
